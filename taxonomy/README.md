...
-   Exit Scam or Rug Pull
    -   * The founders of the crypto project run off with customer and investor money.
    -   * e.g. The emergence of OneCoin invented by Ruja Ignatova, [Cryptoqueen](https://www.bbc.com/news/stories-50435014) scams millions. Ruja's selling point was convincing people that OneCoin was going to be a "better" Bitcoin.
...
-   Romanance Scams
    -   * Malicious scammers leverage dating applications to lure mates into investing in fraudulent cryptocurrency projects. After the victim's money has been received the scammer disappears.
...
-   Fake Hacks
    -   * Project gets hacked by an insider who shares profit with the project team.
...
-   Fake Wallets
    ...
    -   * e.g. Hackers steal $40 million by leveraging two-factor authentication codes and API tokens on [Binance](https://www.wired.com/story/hack-binance-cryptocurrency-exchange/) cryptocurrency exchange.
    
-   Ponzi Schemes
    -   * New entrants or investors are promised good returns while old investors are paid with new investors' money.
    -   * e.g. In 2016, Bitconnect, a proof-of-stake cryptocurrency launched. The project proposed 40% monthly returns for investors lending their Bitcoin and cryptocurrencies on its platform. Bitconnect was exposed as a ponzi scheme by investors and ridiculed by creator of Litecoin, Charlie Lee as well as Vitalik Buterin, co-founder of Ethereum for its spurious promises.
...
-   Scam mining 
    -   * Claims that investors will earn profused cryptocurrency but key information such as difficulty increases and gas fees are not disclosed.
...
-   Spoof ICOs
    -   * Clones of real ICO websites made with the scammer's public key instead of the legitimate public key.
...
-   Sandwich Attack (Front-running Attack)
    -   * A user's transactions are "sandwiched" in between two transactions where the user trades asset X to purchase a large amount of asset Y. The attacker, typically a bot, detects this large trade by purchasing asset Y before the user's transaction is successful. After the attacker's transaction is successful the price of asset Y increases leading to slippage.
...
-   Phishing Attack
    -   * Attackers trick users into clicking a delinquent link with the intent to receive user's personal information such as private keys, addresses, names, and other information that will aid in retrieving stolen funds.
    -   * e.g. BadgerDAO experienced phishing attack Dec 2021 due to a malicious injected snippet into a Badger application via Cloudflare.

-   Dusting Attack
    -   * A dusting attack occurs when a trace amount of cryptocurrency is sent to hundreds-thousands of random addresses. Attackers minuscule amounts of coins to users' crypto wallets to detemine the identity of the respective individual or organization behind a crypto wallet owner.
    -   * e.g. Attackers use knowledge against their victims for extortion. https://www.gemini.com/cryptopedia/crypto-dusting-attack-bitcoin
    - Tip: Don't move the dust coins out of your wallet.
    
-   Fake Audit Scam
    -   * Project lies about receiving smart contract audits from credible auditors
